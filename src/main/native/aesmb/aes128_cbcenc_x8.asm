...
%endif
	...
	pxor		XDATA1, XKEY0	; 0. ARK
	pxor		XDATA2, XKEY0	; 0. ARK
	pxor		XDATA3, XKEY0	; 0. ARK
	pxor		XDATA4, XKEY0	; 0. ARK
	pxor		XDATA5, XKEY0	; 0. ARK
	pxor		XDATA6, XKEY0	; 0. ARK
	pxor		XDATA7, XKEY0	; 0. ARK
	...
	MOVDQ_KEYS	XTMP, [KEYS + 16*5]
	aesenc		XDATA0, XKEY4	; 4. ENC
	aesenc		XDATA1, XKEY4	; 4. ENC
	aesenc		XDATA2, XKEY4	; 4. ENC
	aesenc		XDATA3, XKEY4	; 4. ENC
	aesenc		XDATA4, XKEY4	; 4. ENC
	aesenc		XDATA5, XKEY4	; 4. ENC
	aesenc		XDATA6, XKEY4	; 4. ENC
	aesenc		XDATA7, XKEY4	; 4. ENC

	MOVDQ_KEYS	XKEY6, [KEYS + 16*6]
	aesenc		XDATA0, XTMP	; 5. ENC
	aesenc		XDATA1, XTMP	; 5. ENC
	aesenc		XDATA2, XTMP	; 5. ENC
	aesenc		XDATA3, XTMP	; 5. ENC
	aesenc		XDATA4, XTMP	; 5. ENC
	aesenc		XDATA5, XTMP	; 5. ENC
	aesenc		XDATA6, XTMP	; 5. ENC
	aesenc		XDATA7, XTMP	; 5. ENC

	MOVDQ_KEYS	XTMP, [KEYS + 16*7]
	aesenc		XDATA0, XKEY6	; 6. ENC
	aesenc		XDATA1, XKEY6	; 6. ENC
	aesenc		XDATA2, XKEY6	; 6. ENC
	aesenc		XDATA3, XKEY6	; 6. ENC
	aesenc		XDATA4, XKEY6	; 6. ENC
	aesenc		XDATA5, XKEY6	; 6. ENC
	aesenc		XDATA6, XKEY6	; 6. ENC
	aesenc		XDATA7, XKEY6	; 6. ENC

	MOVDQ_KEYS	XKEY8, [KEYS + 16*8]
	aesenc		XDATA0, XTMP	; 7. ENC
	aesenc		XDATA1, XTMP	; 7. ENC
	aesenc		XDATA2, XTMP	; 7. ENC
	aesenc		XDATA3, XTMP	; 7. ENC
	aesenc		XDATA4, XTMP	; 7. ENC
	aesenc		XDATA5, XTMP	; 7. ENC
	aesenc		XDATA6, XTMP	; 7. ENC
	aesenc		XDATA7, XTMP	; 7. ENC

	MOVDQ_KEYS	XTMP, [KEYS + 16*9]
	aesenc		XDATA0, XKEY8	; 8. ENC
	aesenc		XDATA1, XKEY8	; 8. ENC
	aesenc		XDATA2, XKEY8	; 8. ENC
	aesenc		XDATA3, XKEY8	; 8. ENC
	aesenc		XDATA4, XKEY8	; 8. ENC
	aesenc		XDATA5, XKEY8	; 8. ENC
	aesenc		XDATA6, XKEY8	; 8. ENC
	aesenc		XDATA7, XKEY8	; 8. ENC

	MOVDQ_KEYS	XKEY10, [KEYS + 16*10]
	aesenc		XDATA0, XTMP	; 9. ENC
	aesenc		XDATA1, XTMP	; 9. ENC
	aesenc		XDATA2, XTMP	; 9. ENC
	aesenc		XDATA3, XTMP	; 9. ENC
	aesenc		XDATA4, XTMP	; 9. ENC
	aesenc		XDATA5, XTMP	; 9. ENC
	aesenc		XDATA6, XTMP	; 9. ENC
	aesenc		XDATA7, XTMP	; 9. ENC

	aesenclast	XDATA0, XKEY10	; 10. ENC
	aesenclast	XDATA1, XKEY10	; 10. ENC
	aesenclast	XDATA2, XKEY10	; 10. ENC
	aesenclast	XDATA3, XKEY10	; 10. ENC
	aesenclast	XDATA4, XKEY10	; 10. ENC
	aesenclast	XDATA5, XKEY10	; 10. ENC
	aesenclast	XDATA6, XKEY10	; 10. ENC
	aesenclast	XDATA7, XKEY10	; 10. ENC
