...
public interface BlockCipher {
	 ...
	 *              if the <code>params</code> argument is inappropriate
	 */
	 ...
	 *          the input buffer
	 * @param inOff
	 *          the offset in <code>in</code> where the input starts
	 * @param inLen
	 *          the input length
	 * @param out
	 *          the buffer for the result
	 * @param outOff
	 *          the offset in <code>out</code> where the result is stored
	 * 
	 * @return the number of bytes stored in <code>out</code>
	 * 
	 * @exception DataLengthException
	 *              if there isn't enough data in <code>in</code>, or space in
	 *              <code>out</code>
	 ...
	 * @param isUpdate
	 *          if true the cipher is doing engineUpdate, if false the cipher is
	 *          doing engineDoFinal
	 * 
