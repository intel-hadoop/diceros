...
public class BaseBlockCipher extends CipherSpi {
	 ...
	 * 
	 * @param engine
	 *          the underlying cipher engine, do the actual encryption and
	 *          decryption work
	 */
	 ...
	 * 
	 * @param provider
	 *          provide the the underlying cipher engine which does the actual
	 *          encryption and decryption work
	 */
	...
	protected void engineSetMode(String mode) throws NoSuchAlgorithmException {
		modeName = mode.toUpperCase(Locale.ENGLISH);
	...
	private static class GenericBlockCipherImpl implements GenericBlockCipher {
		...
		public int processBytes(byte[] in, int inOff, int len, byte[] out,
			...
			return cipher.processBlock(in, inOff, len, out, outOff);
		}
